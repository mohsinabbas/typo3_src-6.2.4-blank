...
tt_content.image.20.1 {
    ...
    layout {
        dpbootstrappackage {
            element (
                <img src="typo3conf/ext/dp_kickstart_theme/Resources/Public/Images/blank.gif" class="lazyload" ###SOURCECOLLECTION######PARAMS######ALTPARAMS######SELFCLOSINGTAGSLASH###>
                <noscript>
                    <img src="###SRC###" />
                </noscript>
            )
...
tt_content.stdWrap.innerWrap.cObject {
    ...
    default.30.cObject {
        ...
        default {
            ...
            dp_kickstart_theme_carousel = TEXT
            dp_kickstart_theme_carousel {
                value = >|</div>
            }
        }
        menu >
...
##############################
<INCLUDE_TYPOSCRIPT: source="FILE:EXT:dp_kickstart_theme/Configuration/ContentElements/Bootstrap/TextIcon.ts">
<INCLUDE_TYPOSCRIPT: source="FILE:EXT:dp_kickstart_theme/Configuration/ContentElements/Bootstrap/Carousel.ts">
<INCLUDE_TYPOSCRIPT: source="FILE:EXT:dp_kickstart_theme/Configuration/ContentElements/Bootstrap/Accordion.ts">
<INCLUDE_TYPOSCRIPT: source="FILE:EXT:dp_kickstart_theme/Configuration/ContentElements/Bootstrap/Panel.ts">
<INCLUDE_TYPOSCRIPT: source="FILE:EXT:dp_kickstart_theme/Configuration/ContentElements/Bootstrap/ListGroup.ts">